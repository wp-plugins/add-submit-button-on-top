jQuery(function ($) {
	...
	//$('.plugin-editor-php #wpbody-content .wrap form input[value=Update File]').clone().prependTo('.plugin-editor-php #wpbody-content .wrap form');
	//$('.plugin-editor-php .wrap form > input[value=Update File]').wrap('<p class="submit" style="margin:10px 0 5px 0;padding:0;" />');
        //$('.theme-editor-php #wpbody-content .wrap form input[value=Update File]').clone().prependTo('.theme-editor-php #wpbody-content .wrap form');
	//$('.theme-editor-php .wrap form > input[value=Update File]').wrap('<p class="submit" style="margin:10px 0 5px 0;padding:0;" />');
